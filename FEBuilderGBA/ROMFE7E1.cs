...
{
    sealed class ROMFE7E1 : ROMFEINFO
    {
        public ROMFE7E1(ROM rom)
    	{
            VersionToFilename = "FE7E1";
            TitleToFilename = "FE7";
            ...
            map_config_pointer = 0x0195F4;      //Ist das der richtige Pointer? 
            ...
            image_battle_animelist_pointer = 0x054140;   // Ist das der richtige Pointer?
            ...
            map_terrain_name_pointer = 0x019F48; //Ist das der richtige Pointer?
            ...
            event_haiku_pointer = 0x079654; //Ist das der richtige Pointer?
            event_haiku_tutorial_1_pointer = 0x079660; // Ist das der richtige Pointer?
            event_haiku_tutorial_2_pointer = 0x07965C; // Ist das der richtige Pointer?
            event_force_sortie_pointer = 0x01B0A8; //Ist das der richtige Pointer?
            event_tutorial_pointer = 0x0790E0; //Ist das der richtige Pointer?
            ...
            worldmap_event_on_stageselect_pointer = 0x0B60E4; //Ist das der richtige Pointer?
            ...
            arena_enemy_weapon_basic_pointer = 0x02F7A8; //Ist das der richtige Pointer?
            arena_enemy_weapon_rankup_pointer = 0x02F3CC; //Ist das der richtige Pointer?
            link_arena_deny_unit_pointer = 0; //通信闘技場 禁止ユニット 
            worldmap_road_pointer = 0x0; // ワールドマップの道

            menu_definiton_pointer = 0x01BCF0; //Ist das der richtige Pointer?
            ...
            menu_unit_pointer =  0xC91324; //Ist das der richtige Pointer?
            ...
            worldmap_big_image_pointer = 0x0B66B8; //Ist das der richtige Pointer?
            ...
            battle_bg_pointer = 0x06AF04; //Ist das der richtige Pointer?
            battle_terrain_pointer = 0x04CFB0; //Ist das der richtige Pointer?
            ...
            magic_effect_pointer = 0x05583C; //Ist das der richtige Pointer?
            ...
            oping_event_pointer = 0xca0544; //の
            ending1_event_pointer = 0x12A94; //の
            ending2_event_pointer = 0x12ADC; //の
            RAMSlotTable_address = 0xB92EB0; //の
            ...
            ai1_pointer = 0xC94278;  //Ist das der richtige Pointer?
            ai2_pointer = 0xC9426C;  //Ist das der richtige Pointer?
            ai3_pointer = 0x039957;  //Ist das der richtige Pointer?
            ...
            font_default_begin = 0xB87B68; //の
            font_default_end = 0xB8B9AC; //の
            ...
            vanilla_field_image_address = 0x36B01C; //の
            vanilla_village_config_address = 0x35C63C; //の
            vanilla_village_image_address = 0x33F2C8; //の
            vanilla_casle_config_address = 0x35DB50; //の
            vanilla_casle_image_address = 0x3464F0; //の
            vanilla_plain_config_address = 0x35EE10; //の
            vanilla_plain_image_address = 0x34C74C; //の
            map_minimap_tile_array_pointer = 0x0A2808; //Ist das der richtige Pointer?
