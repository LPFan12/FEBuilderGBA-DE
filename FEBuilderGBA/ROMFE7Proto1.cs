...
namespace FEBuilderGBA
{
    sealed class ROMFE7Proto1 : ROMFEINFO
    {
        public ROMFE7Proto1(ROM rom)
    	{
            ...
            icon_orignal_address = 0xBE11C; // Sollte die richtige Addresse sein.
            ...
            unit_wait_barista_anime_address = 0x026570;  // Ist das der richtige Pointer?
            ...
            support_attribute_pointer = 0x027618;  //Ist das der richtige Pointer?
            terrain_recovery_pointer = 0x019908; //Ist das der richtige Pointer?
            terrain_bad_status_recovery_pointer = 0x019F1C; //Ist das der richtige Pointer?
            terrain_show_infomation_pointer = 0x08565C; //Ist das der Pointer?
            ballista_movcost_pointer = 0x0185F1; //Ist das der richtige Pointer?
            ...
            map_terrain_name_pointer = 0x0198F8; // Ist das der richtige Pointer?
            image_chapter_title_pointer = 0x082508; // Ist das der richtige Pointer?
            image_chapter_title_palette = 0x3C6507; // Ist das die richtige Addresse?
            ...
            event_haiku_pointer = 0x07BA1C; // Ist das der richtige Pointer?
            event_haiku_tutorial_1_pointer = 0x07BA28; // Ist das der richtige Pointer?
            event_haiku_tutorial_2_pointer = 0x07BA24; // Ist das der richtige Pointer?
            event_force_sortie_pointer = 0x08DEA0; // Ist das der richtige Pointer?
            event_tutorial_pointer = 0x07B5C4; //Ist das der richtige Pointer?
            map_exit_point_pointer = 0x03A7DC; // Ist das der richtige Pointer?
            map_exit_point_npc_blockadd = 0x30; // arr[+0x30] からNPCらしい.
            map_exit_point_blank = 0x1BCE44; // Ist das die richtige Addresse?
            ...
            worldmap_event_on_stageselect_pointer = 0x0B354B; // Ist das der richtige Pointer?
            ...
            item_cornered_pointer = 0x02AC48; //Ist das der richtige Pointer?
            ed_1_pointer = 0x027618;  //ED 倒れたら撤退するかどうか
            ...
            generic_enemy_portrait_pointer = 0x730C; //Ist das der richtige Pointer?
