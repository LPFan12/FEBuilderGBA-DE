...
{
    sealed class ROMFE7Proto2 : ROMFEINFO
    {
        public ROMFE7Proto2(ROM rom)
    	{
            VersionToFilename = "FE7P2";
            TitleToFilename = "FE7";
            mask_point_base_pointer = 0x06DC; // Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            mask_pointer = 0x0006E0;  // Huffman tree start (indirected once)
            text_pointer = 0x12AD4; // Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            ...
            max_level_address = 0x02A882; // Ist das die richtige Addresse?
            max_luck_address = 0x02ACAE; // Ist das die richtige Addresse?
            ...
            icon_orignal_max = 0x99; // Sollte die richtige Anzahl sein.
            ...
            unit_wait_icon_pointer = 0x260F8; // Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            unit_wait_barista_anime_address = 0x026BE8;  // Ist das die richtige Addresse?
            ...
            map_config_pointer = 0x194B8;      //Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            map_obj_pointer = 0x194B8;         //Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            map_pal_pointer = 0x194B8;         //Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            map_tileanime1_pointer = 0x194B8;  //Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen. 
            map_tileanime2_pointer = 0x194B8;  //Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            map_map_pointer_pointer = 0x194B8; //Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            map_mapchange_pointer = 0x194B8;   //Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            map_event_pointer = 0x194B8;       //Von der Dokumentation bei (https://feuniverse.us/t/fe7-fe8-prototype-offsets-findings/17220) entnommen.
            ...
            terrain_recovery_pointer = 0x019DF0; //Ist das der richtige Pointer?
            terrain_bad_status_recovery_pointer = 0x019E00; //Ist das der richtige Pointer?
            terrain_show_infomation_pointer = 0x0876F8; //Ist das der richtige Pointer?
            ballista_movcost_pointer = 0x018A70; //Ist das der richtige Pointer?
            ...
            sound_table_pointer = 0x3E40; // Ist das der richtige Pointer?
            sound_room_pointer = 0x01C7F4; // Ist das der richtige Pointer?
            sound_room_datasize = 16; // サウンドルームのデータサイズ
            sound_room_cg_pointer = 0x0AF59C; // Pointer muss getestet werden.
            ...
            event_haiku_pointer = 0x07C06C; // Ist das der richtige Pointer?
            ...
            item_cornered_pointer = 0x02B3A0; //すくみの開始位置
            ...
            cc_item_hero_crest_pointer = 0x0287C8;  //Ist das der richtige Pointer?
            cc_item_knight_crest_pointer = 0x0287D0;  //Ist das der richtige Pointer?
            cc_item_orion_bolt_pointer = 0x0287D8;  //Ist das der richtige Pointer?
            cc_elysian_whip_pointer = 0x0287E0;  //Ist das der richtige Pointer?
            cc_guiding_ring_pointer = 0x0287E8;  //Ìst das der richtige Pointer?
            cc_fallen_contract_pointer = 0x028808;  //Ist das der richtige Pointer?
            cc_master_seal_pointer = 0x0287F0;  //Ist das der richtige Pointer?
            cc_ocean_seal_pointer = 0x028810;  //Ist das der richtige Pointer?
            cc_moon_bracelet_pointer = 0x0287F8;  //Ist das der richtige Pointer?
            cc_sun_bracelet_pointer = 0x028800;  //Ist das der richtige Pointer?
            unit_increase_height_pointer = 0x6D40;  //Ist das der richtige Pointer?
            unit_increase_height_switch2_address = 0x6D30;  //Ist das die richtige Addresse?
            ...
            status_font_pointer = 0x5ED0;  //Ist das der richtige Pointer?
            ...
            arena_class_near_weapon_pointer = 0x03017C; //Ist das der richtige Pointer?
            arena_class_far_weapon_pointer = 0x030188; // Ist das der richtige Pointer?
            arena_class_magic_weapon_pointer = 0x0301D8; // Ist das der richtige Pointer?
            arena_enemy_weapon_basic_pointer = 0x0303E0; // Ist das der richtige Pointer?
            arena_enemy_weapon_rankup_pointer = 0x030400; // Ist das der richtige Pointer?
            ...
            worldmap_big_palette_pointer = 0x0B8FD0; //Ist das der richtige Pointer?
            worldmap_big_dpalette_pointer = 0x0; //ワールドマップ フィールドになるでかい奴 闇パレット  
            worldmap_big_palettemap_pointer = 0x0B8DDC; //Ist das der richtige Pointer?
            worldmap_event_image_pointer = 0x0B8FFC; //Ist das der richtige Pointer?
            worldmap_event_palette_pointer = 0x0B8FF8; //Ist das der richtige Pointer?
            worldmap_event_tsa_pointer = 0x0B9008; //Ist das der richtige Pointer?
            ...
            battle_screen_TSA1_pointer = 0x050168;  //Ist das der richtige Pointer?
            battle_screen_TSA2_pointer = 0x05016C;  //Ist das der richtige Pointer?
            ...
            ai_preform_staff_pointer = 0x03C69C;  //Ist das der richtige Pointer?
            ...
            ai_map_setting_pointer = 0x035FE4;  //Ist das der richtige Pointer?
            ...
            tactician_affinity_pointer = 0x01D3B0; //Ist das der richtige Pointer?
            event_final_serif_pointer = 0x80CDC; //Ist das der richtige Pointer?
            ...
            version = 219;    // Eigene Spielversion für den Prototypen wegen technischen Gründen.
