...
namespace FEBuilderGBA
{
    sealed class ROMFE8E : ROMFEINFO
    {
        public ROMFE8E(ROM rom)
        {
           ...
           monster_wmap_probability_1_pointer = 0x0C17C4; //Ist das der richtige Pointer?
           ...
           oping_event_pointer = 0x8B39F0; //の
           ending1_event_pointer = 0x9EC0; //の
           ending2_event_pointer = 0x9ED8; //の
           RAMSlotTable_address = 0x59A5D0; //の
           ...
           item_usability_array_switch2_address = 0x2889A; //の
           item_effect_array_pointer = 0x2FC8C;     //アイテムを利用した場合の効果を定義する
           item_effect_array_switch2_address = 0x2FC72; //の
           item_promotion1_array_pointer = 0x29218;    //CCアイテムを使った場合の処理を定義する
           item_promotion1_array_switch2_address = 0x29202; //の
