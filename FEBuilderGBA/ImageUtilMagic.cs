    ...
    class ImageUtilMagic
    {
        ...
        public static magic_system_enum SearchMagicSystem(out uint baseaddr, out uint dimaddr, out uint nodimaddr)
        {
            MagicPatchTableSt[] table = new MagicPatchTableSt[] { 
                ...
                new MagicPatchTableSt{ name="SCA_Creator",	ver = "FE6D", addr = 0x2DC078,data = new byte[]{0x19 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x03 ,0x00 ,0x00 ,0x00 ,0x61 ,0xC1 ,0x2D ,0x08},dim = 0x2DC091,no_dim = 0x2dc129},
                new MagicPatchTableSt{ name="FEditor",	ver = "FE6D", addr = 0x2DC078,data = new byte[]{0x19 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x03 ,0x00 ,0x00 ,0x00 ,0xC5 ,0xC1 ,0x2D ,0x08},dim = 0x2dc091,no_dim = 0x2DC17F },
                new MagicPatchTableSt{ name="SCA_Creator",	ver = "FE6E", addr = 0x2DC078,data = new byte[]{0x19 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x03 ,0x00 ,0x00 ,0x00 ,0x61 ,0xC1 ,0x2D ,0x08},dim = 0x2DC091,no_dim = 0x2dc129},
                new MagicPatchTableSt{ name="FEditor",	ver = "FE6E", addr = 0x2DC078,data = new byte[]{0x19 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x03 ,0x00 ,0x00 ,0x00 ,0xC5 ,0xC1 ,0x2D ,0x08},dim = 0x2dc091,no_dim = 0x2DC17F },
                new MagicPatchTableSt{ name="SCA_Creator",	ver = "FE6U", addr = 0x2DC078,data = new byte[]{0x19 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x03 ,0x00 ,0x00 ,0x00 ,0x61 ,0xC1 ,0x2D ,0x08},dim = 0x2DC091,no_dim = 0x2dc129},
                new MagicPatchTableSt{ name="FEditor",	ver = "FE6U", addr = 0x2DC078,data = new byte[]{0x19 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x00 ,0x03 ,0x00 ,0x00 ,0x00 ,0xC5 ,0xC1 ,0x2D ,0x08},dim = 0x2dc091,no_dim = 0x2DC17F },
        ...
        static uint FindCSASpellTableLow(string type, out uint out_pointer)
        {
            SpellTableSt[] table = new SpellTableSt[] { 
                ...
                new SpellTableSt{ name="SCA_Creator",	ver = "FE6D",data = new byte[]{0x48 ,0x19 ,0x02 ,0x02 ,0x00 ,0x01 ,0x00 ,0x80 ,0x91 ,0xC0 ,0x2D ,0x08 ,0x29 ,0xC1 ,0x2D ,0x08}},
                new SpellTableSt{ name="FEditor",	ver = "FE6D",data = new byte[]{0xE7 ,0x7D ,0xB4 ,0x01 ,0x34 ,0xFF ,0x03 ,0x02 ,0x80 ,0xD7 ,0x95 ,0x08 ,0x1A ,0xE1 ,0x03 ,0x02}},
                new SpellTableSt{ name="SCA_Creator",	ver = "FE6E",data = new byte[]{0x48 ,0x19 ,0x02 ,0x02 ,0x00 ,0x01 ,0x00 ,0x80 ,0x91 ,0xC0 ,0x2D ,0x08 ,0x29 ,0xC1 ,0x2D ,0x08}},
                new SpellTableSt{ name="FEditor",	ver = "FE6E",data = new byte[]{0xE7 ,0x7D ,0xB4 ,0x01 ,0x34 ,0xFF ,0x03 ,0x02 ,0x80 ,0xD7 ,0x95 ,0x08 ,0x1A ,0xE1 ,0x03 ,0x02}},
                new SpellTableSt{ name="SCA_Creator",	ver = "FE6U",data = new byte[]{0x48 ,0x19 ,0x02 ,0x02 ,0x00 ,0x01 ,0x00 ,0x80 ,0x91 ,0xC0 ,0x2D ,0x08 ,0x29 ,0xC1 ,0x2D ,0x08}},
                new SpellTableSt{ name="FEditor",	ver = "FE6U",data = new byte[]{0xE7 ,0x7D ,0xB4 ,0x01 ,0x34 ,0xFF ,0x03 ,0x02 ,0x80 ,0xD7 ,0x95 ,0x08 ,0x1A ,0xE1 ,0x03 ,0x02}},
