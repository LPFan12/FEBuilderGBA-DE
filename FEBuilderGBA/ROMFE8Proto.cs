...
namespace FEBuilderGBA
{
    sealed class ROMFE8Proto : ROMFEINFO
    {
        public ROMFE8Proto(ROM rom)
        {
            ...
            cc_item_hero_crest_pointer = 0x12D768;   //Ist das der richtige Pointer?
            cc_item_knight_crest_pointer = 0x12D76C;   //Ist das der richtige Pointer?
            cc_item_orion_bolt_pointer = 0x12D770;   //Ist das der richtige Pointer?
            cc_elysian_whip_pointer = 0x12D774;   //Ist das der richtige Pointer?
            cc_guiding_ring_pointer = 0x12D778;   //Ist das der richtige Pointer?
            cc_fallen_contract_pointer = 0x12D788;   //Ist das der richtige Pointer?
            cc_master_seal_pointer = 0x12D77C;   //Ist das der richtige Pointer?
            cc_ocean_seal_pointer = 0x12D78C;   //Ist das der richtige Pointer?
            cc_moon_bracelet_pointer = 0x12D784;   //Ist das der richtige Pointer?
            cc_sun_bracelet_pointer = 0x12D780;   //Ist das der richtige Pointer?
